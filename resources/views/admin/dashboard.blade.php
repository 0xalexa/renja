            ...
            <div class="hope-col-right">
              ...
              <div class="hope-card hope-calendar-card" id="hopeCalendarCard">
                <div class="cal-header">
                  <button class="cal-nav-btn" onclick="showAdminToast('Bulan sebelumnya', 'info')">&lsaquo;</button>
                  <span>{{ date('F Y') }}</span>
                  <button class="cal-nav-btn" onclick="showAdminToast('Bulan berikutnya', 'info')">&rsaquo;</button>
                </div>
                ...
                <div class="cal-days-grid" id="calDaysGrid">
                  ...
                  <span class="cal-day empty"></span>
                  <span class="cal-day" onclick="selectCalDay(this, 1)">1</span>
                  <span class="cal-day" onclick="selectCalDay(this, 2)">2</span>
                  <span class="cal-day" onclick="selectCalDay(this, 3)">3</span>
                  <span class="cal-day" onclick="selectCalDay(this, 4)">4</span>
                  <span class="cal-day" onclick="selectCalDay(this, 5)">5</span>
                  <span class="cal-day" onclick="selectCalDay(this, 6)">6</span>
                  <span class="cal-day" onclick="selectCalDay(this, 7)">7</span>
                  <span class="cal-day" onclick="selectCalDay(this, 8)">8</span>
                  <span class="cal-day {{ date('j') == 9 ? 'active-today' : '' }}" onclick="selectCalDay(this, 9)">9</span>
                  <span class="cal-day" onclick="selectCalDay(this, 10)">10</span>
                  <span class="cal-day" onclick="selectCalDay(this, 11)">11</span>
                  <span class="cal-day" onclick="selectCalDay(this, 12)">12</span>
                  <span class="cal-day" onclick="selectCalDay(this, 13)">13</span>
                  <span class="cal-day" onclick="selectCalDay(this, 14)">14</span>
                  <span class="cal-day" onclick="selectCalDay(this, 15)">15</span>
                  <span class="cal-day" onclick="selectCalDay(this, 16)">16</span>
                  <span class="cal-day" onclick="selectCalDay(this, 17)">17</span>
                  <span class="cal-day" onclick="selectCalDay(this, 18)">18</span>
                  <span class="cal-day" onclick="selectCalDay(this, 19)">19</span>
                  <span class="cal-day" onclick="selectCalDay(this, 20)">20</span>
                  <span class="cal-day" onclick="selectCalDay(this, 21)">21</span>
                  <span class="cal-day" onclick="selectCalDay(this, 22)">22</span>
                  <span class="cal-day" onclick="selectCalDay(this, 23)">23</span>
                  <span class="cal-day" onclick="selectCalDay(this, 24)">24</span>
                  <span class="cal-day" onclick="selectCalDay(this, 25)">25</span>
                  <span class="cal-day" onclick="selectCalDay(this, 26)">26</span>
                  <span class="cal-day" onclick="selectCalDay(this, 27)">27</span>
                  <span class="cal-day" onclick="selectCalDay(this, 28)">28</span>
                  <span class="cal-day" onclick="selectCalDay(this, 29)">29</span>
                  <span class="cal-day" onclick="selectCalDay(this, 30)">30</span>
                </div>
