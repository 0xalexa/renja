...
// ==========================================================================
// GRAFIK CHART.JS ADMIN (DONUT CHART STATUS DOKUMEN)
// ==========================================================================
function initAdminChart() {
  ...
  if (isDonut) {
    chartAdminInstance = new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['Lengkap', 'Diproses', 'Perlu Update', 'Terkirim'],
        datasets: [{
          data: [countLengkap, countDiproses, countPerluUpdate, countTerkirim],
